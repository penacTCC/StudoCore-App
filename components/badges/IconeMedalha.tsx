...
type Props = {
    ...
    badgeId: string;
    /** nome do ícone lucide, usado como fallback quando a medalha não tem arte própria */
    icon: string;
    size: number;
    color: string;
    locked?: boolean;
...
/**
 * Algumas medalhas têm arte própria (PNG); as demais continuam com o ícone lucide colorido
 ...
 * fallback em lucide ganha um quadrado tingido pela cor do nível para ficar do mesmo tamanho.
 */
