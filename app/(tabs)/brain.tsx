                    ...
                    <View className="px-4 pb-4 gap-4">
                        ...
                        <View className="bg-slate-900 border border-slate-800 rounded-3xl p-4">
                            ...
                            <View className="flex-row gap-3">
                                <StatCard value={28} label="Hours" />
                                <StatCard value={10} label="Streak" valueColor={COLORS.emeraldLight} />
                                <StatCard value={45} label="Questions" valueColor={COLORS.violetLight} />
                            </View>
                        </View>
                    </View>
                )}
