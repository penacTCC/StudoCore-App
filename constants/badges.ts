...
const ELITE: BadgeType[] = [
    ...
    { id: 'questions_2000', name: 'Duas Mil Questões', description: 'Respondeu 2000 questões. Status excepcional.', icon: 'Gem', level: 'elite', requirementType: 'questions', requirementValue: 2000 },
    ...
    { id: 'hours_2000', name: 'Duas Mil Horas', description: '2000 horas de estudo. Nível de mestrado real!', icon: 'Diamond', level: 'elite', requirementType: 'hours', requirementValue: 2000 },
];
